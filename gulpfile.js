...
const spriteBuild = require('gulp-svg-sprite');
...
function icons(){
    return src(path.src.icons, {base: srcPath})
    .pipe(spriteBuild(
        {
            mode: {
                stack: {
...
const build = gulp.series(clean, gulp.parallel(html, css, js, images, webpImages, fonts , icons))
